...
"""
  ...
  Scenario Outline: Patient Data Creation
    ...
    ====================================================INSURANCE PMI===================================================
    dataPMI = P0:Insurance Rank,P1:Relationship To CardHolde,P2:Cardholder Name,P3:Cardholder DOB,P4:Insurance Payer Name,
    ...
    CONFIG DATA:
      ...
      | admin | P0:AutTest_,P1:RND,P2:RND,P3:RND,P4:Mobile,P5:RND,P6:RND,P7:RND,P8:RND,P9:RND,P10:RND,P11:RND | NOPI          | P0:RND,P1:Self,P2:N_A,P3:N_A,P4:UAT Test Payer 1,P5:UAT Payer Test Plan 1,P6:13019658622,P7:RND,P8:RND,P9:RND | P0:RND,P1:Self,P2:N_A,P3:N_A,P4:UAT Test Payer 1,P5:UAT Payer Test Plan 1,P6:13019658622,P7:RND,P8:RND,P9:RND,P10:N_A,P11:N_A | P0:hca,P1:internal.facility,P2:PF | Active, Today, RND, Self     | ANP       | DNC        | P0:RND,P1:Open |
