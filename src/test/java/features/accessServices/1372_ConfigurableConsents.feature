...
"""
  ...
  Scenario Outline: Create an (AZ/DSI) product enrollment with Outline tables
    ...
    Examples:
    ====================================================ACCOUNDATA======================================================
    accData = P0:Identifier,P1:First Name,P2:Last Name,P3:First Phone/Fax,P4:First Phone/Fax Type,P5:Second Phone/Fax,
    P6:Second Phone/Fax Type,P7:ZipCode,P8:EmailDomain,P9:Address,P10:Date,P11:City
    e.g.
  ...
  Scenario Outline: Create an Account with PE to create a Consent at Account level
    ...
    P0:N_A,P1:CuterfasoDos,P2:MocherfasoDos,P3:RND,P4:RND,P5:RND,P6:RND,P7:RND,P8:RND,P9:RND,P10:RND,P11:RND
    ====================================================================================================================
      | dummyValue  | externalID | selectedView    | accountType | accData                                                                                    | consentType | consentTypeOption | consentStatus | consentDate | consentSource | consentAuth | product   | accountKeyValueJSON | consentKeyValueJSON | fileNameJSON | randomSelection | createPE |
      | dummySearch | LJijh8A    | Recently Viewed | CPC         | P0:AutTest_,P1:RND,P2:RND,P3:RND,P4:RND,P5:RND,P6:RND,P7:RND,P8:RND,P9:RND,P10:RND,P11:RND | DSI         | DNC               | Active        | 1/25/2021   | Fax           | Self        | Calquence | accountType         | consentType         | ConstantData | N_A             | Y        |
